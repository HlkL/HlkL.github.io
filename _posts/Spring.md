...
author:     "HG"
header-img: "img/bg/post-spring.jpg"
tags:
    - Web
    - Java
    - Spring
...
<img src="https://cache.yisu.com/upload/information/20200623/121/115741.png">
### 1. xml配置文件开发
#### 依赖注入
##### 构造方法注入
...
![请添加图片描述](https://img-blog.csdnimg.cn/e86ee4b5e7e044d8816adceec282d187.png)
##### set方法注入
**实体类**
```java
@Data
...
<img src="https://docs.spring.io/spring-framework/docs/current/reference/html/images/singleton.png" alt="原型模式"/>
###### 原型模式
原型模式（Prototype Pattern）是用于创建重复的对象，同时又能保证性能。这种类型的设计模式属于创建型模式，它提供了一种创建对象的最佳方式。
这种模式是实现了一个原型接口，该接口用于创建当前对象的克隆。当直接创建对象的代价比较大时，则采用这种模式。
例如，一个对象需要在一个高代价的数据库操作之后被创建。我们可以缓存该对象，在下一个请求时返回它的克隆，在需要的时候更新数据库，以此来减少数据库调用。
<img src="https://docs.spring.io/spring-framework/docs/current/reference/html/images/prototype.png" alt="原型模式"/>
...
```
1. 单例模式测试
![请添加图片描述](https://img-blog.csdnimg.cn/d46e8ff8b7e9416a8615724c24a82d29.png)

3. 原型模式测试
![](https://img-blog.csdnimg.cn/16a7ae2d5b814f918962cbb2320c5678.png)
#### 2. 配置类+注解
...
### 3. 注解开发和xml开发对比
![](https://img-blog.csdnimg.cn/665338da3d3e4204b500015a3185b658.png)
## 2. AOP
### 1. 代理模式
在代理模式（Proxy Pattern）中，一个类代表另一个类的功能。这种类型的设计模式属于结构型模式。
在代理模式中，我们创建具有现有对象的对象，以便向外界提供功能接口。
为其他对象提供一种代理以控制对这个对象的访问。
![](https://img-blog.csdnimg.cn/308d3684def34e80b234b8e6c79e3b62.png)
#### 1. 静态代理
...
```
![](https://img-blog.csdnimg.cn/52ed3e31606e481baa507ee703140eb9.png)
...
![](https://img-blog.csdnimg.cn/7b131ab2c5de43cea928b456ddb46efe.png)
**出售**
```java
...
```
![](https://img-blog.csdnimg.cn/b2c9ab107202426aa0ba250a20e4098b.png)
### 2. AOP织入
#### 方式一
**接口**
```java
...
```
![](https://img-blog.csdnimg.cn/d97705370f8446edabd8b055aba4e7ad.png)
...
```
![](https://img-blog.csdnimg.cn/a8f53437f0df49b5af6fc45491fb4d07.png)
...
```
![](https://img-blog.csdnimg.cn/16fdb8d37a484f7fb633fe2ead3a8347.png)
...
```
![](https://img-blog.csdnimg.cn/a5eff94eb0504d1b82c8dc8b5d25a7ce.png)
...
```
![](https://img-blog.csdnimg.cn/63ab4f89cff04c38950eb27d38c1851b.png)
...
### 事务测试
数据库原始数据
![](https://img-blog.csdnimg.cn/8ed32456f41e4964ad531df0316d9931.png)
...
```
1. 通过修改sql语句制造错误
![](https://img-blog.csdnimg.cn/b79822b68a0e40cfb3218e631d38327c.png)

**运行结果**
![](https://img-blog.csdnimg.cn/f2eb9664b88d48d69cffe693d5258418.png)

**尽管运行日志中显示插入一条数据,但此时因为删除操作sql语句的错误,数据库中并没有写入数据**
![](https://img-blog.csdnimg.cn/48656a1f48234464875c9e4d31830b48.png)
2. 使用正确的sql语句进行测试
![](https://img-blog.csdnimg.cn/d4202b26a99a4e8f9499cba1af208736.png)
**测试通过的同时,数据库中也对应的更新了数据**
![](https://img-blog.csdnimg.cn/8d84cb164c184aaf85a33d0f2e18cff3.png)
